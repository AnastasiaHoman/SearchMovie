...
$key = '26cf73d751bbf8101d80478735b38916';


function getSearchResult($key, $title, $page, $year, $adult)
{
	$url = 'https://api.themoviedb.org/3/search/multi?api_key='.$key.'&language=en-US&query='.$title.'&page='.$page.'&include_adult='.$adult.'&year='.$year;
